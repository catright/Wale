    ...
    public class Core : IDisposable
    {
        ...
        public void Restart()
        {
            ...
            lock (sessionLocker)
            {
                ...
                MasterEPVolume = null;
                DefDevice?.Dispose();
                //Log("Restart core: Master cleared");
                UpdateDevice();// Log("Restart core: Master device is restarted");
                Restarted = true;
                GetSessionManager();// Log("Restart core: Session manager is restarted");
                //Start();
            }
            Restarting = false;
            Log("Restart core: OK");
